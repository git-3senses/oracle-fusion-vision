      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold mb-6 animate-fade-in">
            ...
            <span className="text-gradient-primary"> Enterprise Success</span>
          </h2>
          ...
          {coreServices.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start space-x-4 mb-6">
                <div className={`flex-shrink-0 w-14 h-14 bg-gradient-${service.color} rounded-xl flex items-center justify-center`}>
            ...
            <div className="space-y-8">
              <div>
                ...
                <h3 className="text-3xl lg:text-4xl font-bold mb-6">
                  ...
                  <span className="text-gradient-primary"> Business Functions</span>
                </h3>
